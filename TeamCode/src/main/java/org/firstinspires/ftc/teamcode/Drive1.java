/*
Sep 30 - Arm up not limited by encoder
Jan 24 - Added dpad buttons to control arm positions
Jan 31 - This program based from MyTeleOp5
Fixed stutter created by gamepad1 left and right bumpers
motor speed was set to zero if bumpers not pushed
Added variables for encoder values for each arm position
Added distance sensor
Nov 3 - Changed gripper controls to intuitive controls
Oct 23.23 - Rebirth, added necessary stuff for new servos and motors and fixed some of the bad naming
TODO: Set all moving stuff up!!!!!!!!!!
Nov 2: Set some speeds and now it's kind of easy to control
Nov 5-10: Implemented system of self-leveling gripper angle servo (doesn't really work right now)

23.Oct.2024: Back for another deep year... (updated motors+controls btw)
...
@TeleOp(name="Drive1", group="Linear Opmode")
...
public class Drive1 extends LinearOpMode {
   ...
   public void runOpMode() {
       ...
       while (opModeIsActive()) {
           ...
           telemetry.addData("Gripper right", String.format("position=%.2f", gripper2.getPosition()));
